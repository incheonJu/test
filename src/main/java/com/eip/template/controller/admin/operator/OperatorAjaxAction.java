 ...
 * Filename : OperatorAjaxAction.java 
* Comment  : 
...
public class OperatorAjaxAction
{
    @Autowired
    ...
    * </PRE>
     ...
     *@return
     */
    @RequestMapping(value = "/operatorJqList", method = RequestMethod.GET)
    @ResponseBody
    public JqGridData<Operator> operatorJqList(
            ...
            @RequestParam(value = "priv05", required=false, defaultValue="0") int priv05)
    {
    	...
    	/*return operatorService.getOperatorGridList(page, rows, sord, sidx, parameters);*/
    	return null;
    }
    ...
    * </PRE>
    ...
    {
        /*return operatorService.checkDuplicateID(id);*/
        return null;
    }
}
