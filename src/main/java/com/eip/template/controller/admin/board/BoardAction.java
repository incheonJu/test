...
public class BoardAction 
{
	...
	* </PRE>
    ...
    public String showBoardListPage(ModelMap model,
    		@RequestParam(value = "page", required=false, defaultValue="1") int page,
    		@RequestParam(value = "searchString", required=false, defaultValue="") String searchString) // 요청 페이지 값
    {
        model.addAttribute("states", boardService.getAll().getObject());
	...
	* </PRE>
	...
	{
	    	logger.debug("Insert Data : " + board);
	...
	* </PRE>
			...
			)
	{
	        ...
	        return "redirect:/admin/board/boardList?page="+page;
	}
