			...
			<div class="loginArea">
				...
				<div class="loginBx">
					<div class="loginboxarea">
						...
						<div class="inputArea">
							<div class="inputBox">
								<label for="operName" class="lbl">이름</label> <input type="text" name="operName" id="operName" class="intBox" />
				...
				<div class="memjoinBtn">
					<p class="joinbtn">
						<input name="Btn_Login" type="button" class="join_btn" value="회원가입하기" onclick="location.href='${pageContext.request.contextPath}/admin/operator/register'" />
					</p>
				</div>
			</div>
		</div>
...
function fnFindId() {
	...
	if (!operName.length > 0) {
		...
		var url = contextPath + "/admin/findId";
		
		var data = '{"operName":"' + operName + '","email":"' + email + '"}';
