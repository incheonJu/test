...
<div id="scArea">
	<sf:form method="POST" modelAttribute="qna" action="${pageContext.request.contextPath}/admin/board/qnaInsertProcess" enctype="multipart/form-data">
		<table class="table_mem">
			...
			<tr>
				...
				<td colspan="3">
					...
					<input type="hidden" name="qnaEtc" id="qnaEtc"/>
				</td>
			</tr>
			<tr>
