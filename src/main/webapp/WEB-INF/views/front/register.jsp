...
<body>
	    <div id="joinAreaBg">
	    	<div class="joinArea">
	        	<h2 class="title">사용자 회원가입 </h2>
					<sf:form id="memberForm" modelAttribute="member" action="${pageContext.request.contextPath}/front/member/memberRegister">
						<table class="table_mem">
							<tr>
								<th width="15%" scope="col">* 아이디</th>
								<td colspan="3">
									<sf:input path="memberId" size="30" maxlength="32" style="ime-mode:disabled;" onkeyup="NoHanGle(event, this);checkID()" />
							...
							<tr>
								<th scope="col">* 이름</th>
								<td colspan="3">
									<sf:input path="memberName" size="30" maxlength="6"/>
								</td>
							</tr>
							<tr>
								<th scope="col">* 비밀번호</th>
								<td colspan="3">
									<sf:password path="memberPwd" size="30" maxlength="100" onkeyup="checkPwd()"/><span id="idPwdResult">비밀번호는 6글자 이상입니다.</span>
								</td>
							</tr>
							<tr>
								<th scope="col">* 비밀번호 확인</th>
								<td colspan="3">
									<input type="password" id="memberPwd2" size="30" maxlength="100" onkeyup="checkPwd2()"/><span id="idPwdConfrimResult"></span>
								</td>
							</tr>
							<tr>
								<th scope="col">* 이메일</th>
						...
						<p class="joinBtn">
							...
							<img src="${pageContext.request.contextPath}/img/admin/button/btn_cancel.gif" width="57" height="23" onclick="$(location).attr('href', '${pageContext.request.contextPath}/front')"  alt="취소"/>
						</p>
					</sf:form>
				</div>
			</div>
	...
	function checkID() {
		...
		if (id.length < 6 || id.length > 12)
		{
			...
			$.ajax({
				type : "GET",
				async : false,
				url : "${pageContext.request.contextPath}" + "/front/member/checkID/" + id,
