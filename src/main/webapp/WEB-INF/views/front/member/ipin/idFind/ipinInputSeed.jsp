<%
/**************************************************************************************************************************
* Program Name  : SIREN24 아이핀 서비스 요청 페이지 Sample (JSP)
    ...
    <head>
		...
		<form name="reqCBAForm" method="post" action="ipinRequestSeed.jsp">
                ...
                <table cellpadding=1 cellspacing=1>
                    ...
                    <tr>
                        <td align=center>결과수신URL</td> <!-- 결과수신 URL(23http:// 포함한 주소) -->
		...
		<br/>
			<table width="450" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td width="130"><a href=http://www.siren24.com/v2alimi/comm/jsp/v2alimiAuth.jsp?id=SIR005&svc_seq=01 target=blank><img src="http://ntest.siren24.com/name/images/logo01.gif" width="122" height="41" border="0" alt="로고"></a></td>
