...
<div id="scArea">
	<sf:form method="POST" modelAttribute="qna" action="${pageContext.request.contextPath}/front/board/qnaUpdateProcess">
		<table class="table_mem">
			<input type="hidden" name="createId" value="${qna.createId}"/>
			<input type="hidden" name="qnaSeq" value="${qna.qnaSeq}"/>
			<tr>
				<th width="15%" scope="col">이름</th>
				<td colspan="3">
					<Input Type='Text' name="createName" id="createName" value='${qna.createName}' Size='30' MaxLength='6'>
				</td>
			</tr>
			<tr>
				...
				<td colspan="3">
					...
					<c:set var="arrEmail" value="${fn:split(qna.createEmail,'@')}"/>
			...
			<tr>
				...
				<td colspan="3">
					...
					<input name="createTel2" id="createTel2" type="text" maxlength="4" size="10" onKeyDown="NumberOnly(event,this);" value="${qna.createTel2}"/> - 
					<input name="createTel3" id="createTel3" type="text" maxlength="4" size="10" onKeyDown="NumberOnly(event,this);" value="${qna.createTel3}"/>
					
					<script type="text/javascript">
						$("#createTel1").val('${qna.createTel1}');
					</script>
				</td>
			</tr>
			<tr>
				...
				<td colspan="3">
					<input type="radio" name="openYn" id="openYn" class="chkbox" value="Y" <c:if test="${qna.openYn == 'Y'}">checked</c:if>>
					<label for="openYn">공개</label>&nbsp;&nbsp;
					<input type="radio" name="openYn" id="openYn" class="chkbox" value="N" <c:if test="${qna.openYn == 'N'}">checked</c:if>>
			...
			<tr>
				...
				<td colspan="3">
					<input name="qnaTitle" id="qnaTitle" size="100" maxlength="100" value="${qna.qnaTitle}"/>
				</td>
			</tr>
		...
		<p class="joinBtn">
			...
			<img id="listButton" src="${pageContext.request.contextPath}/img/admin/button/btn_list.gif" width="57" height="23"
				onclick="window.location.href = '${pageContext.request.contextPath}/admin/board/qnaList';"  alt="목록"/>
		</p>
	</sf:form>
</div>
