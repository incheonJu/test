...
<body>
	<div id="login-wrap">
			EIP 로그인
		<div class="loginArea">
			<s:url var="authUrl" value="/front/j_spring_security_check_member" />
			<form name="form1" id="loginForm" method="post" action="${authUrl}">
				...
				<br/>
				<br/> <input type="button" name="button" id="button" value="회원가입" onclick="location.href='${pageContext.request.contextPath}/front/member/register'" />
				<input type="button" name="button" id="button" value="아이디/비밀번호 찾기" onclick="location.href='${pageContext.request.contextPath}/front/member/findMember'" />
			</form>
		</div>
	</div>
