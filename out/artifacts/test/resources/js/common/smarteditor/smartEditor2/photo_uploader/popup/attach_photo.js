    ...
    function html5Upload() {	
		...
		//sUploadURL= 'file_uploader_html5.asp'; 	//upload URL
		sUploadURL= '/common/fileupload/test_uploadProc.asp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			...
			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/common/fileupload/test_uploadProc.asp',	//샘플 URL입니다.
