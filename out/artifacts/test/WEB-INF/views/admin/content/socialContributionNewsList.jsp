...
<form method="post" name="frmDelete" action="/admin/socialContributionNews/delete">
	<input type="hidden" id="arrSeq" name="arrSeq" value="" />
</form>
<form method="get" name="frmSearch" action="/admin/socialContributionNews/list">
	<table>
		<tbody>
			<tr>
				<td align="left">
...
<c:import url="../../common/paging.jsp">
	<c:param name="queryStr" value="/admin/socialContributionNews/list?top_exposure_yn=${top_exposure_yn}&list_exposure_yn=${list_exposure_yn}&keyfield=${keyfield}&keyword=${keyword}" />
</c:import>
<script>
