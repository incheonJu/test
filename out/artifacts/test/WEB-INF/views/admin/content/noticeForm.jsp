...
<c:set var="mode" value="${notice == null ? '/admin/notice/insert' : '/admin/notice/update'}" />
<form method="post" name="frmEdit" action="${mode}" enctype="multipart/form-data">
<input type="hidden" name="seq" value="${notice.seq == null ? 0 : notice.seq}" />
<input type="hidden" name="topImgPath" value="${notice.topImgPath}" />
<input type="hidden" name="listImgPath" value="${notice.listImgPath}" />
	...
	<table class="uiTable write">
		...
		<tbody>
			<tr>
				...
				<td>
					<span class="uiInput check">
						...
						<input name="langKorYn" class="exposureLang" id="langKorYn" type="checkbox" value="Y" ${notice.langKorYn} />
						<label for="langKorYn">국문</label>
						<input name="langEngYn" class="exposureLang" id="langEngYn" type="checkbox" value="Y" ${notice.langEngYn} />
						<label for="langEngYn">영문</label>
						<input name="langChnYn" class="exposureLang" id="langChnYn" type="checkbox" value="Y" ${notice.langChnYn} />
						<label for="langChnYn">중문</label>
						<input name="langJpnYn" class="exposureLang" id="langJpnYn" type="checkbox" value="Y" ${notice.langJpnYn} />
			...
			<tr id="titleKor">
				...
				<td>
					<span class="uiInput text">
						<input name="titleKor" type="text" value="${notice.titleKor}" maxlength="100" style="width:900px;" />
			...
			<tr id="titleEng">
				...
				<td>
					<span class="uiInput text">
						<input name="titleEng" type="text" value="${notice.titleEng}" maxlength="100" style="width:900px;" />
						<label>최대 30자 까지 가능합니다.</label>
					</span>
				</td>
			</tr>
			<tr id="titleChn">
				...
				<td>
					<span class="uiInput text">
						<input name="titleChn" type="text" value="${notice.titleChn}" maxlength="100" style="width:900px;" />
						<label>최대 30자 까지 가능합니다.</label>
					</span>
				</td>
			</tr>
			<tr id="titleJpn">
				...
				<td>
					<span class="uiInput text">
						<input name="titleJpn" type="text" value="${notice.titleJpn}" maxlength="100" style="width:900px;" />
						<label>최대 30자 까지 가능합니다.</label>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="uiInput file">
						...
						<input type="text" name="topImgAlt" value="${notice.topImgAlt}"  />
						<c:if test="${notice.topImgPath != '' && notice.topImgPath != null}">
							<a href="/download${notice.topImgPath}" class="uiButton"><span>${notice.topImgName} 다운로드</span></a>
						</c:if>
			...
			<tr>
				...
				<td>
					<span class="uiInput file">
						...
						<input type="text" name="listImgAlt" value="${notice.listImgAlt}"  />
						<c:if test="${notice.listImgPath != '' && notice.listImgPath != null}">
							<a href="/download${notice.listImgPath}" class="uiButton"><span>${notice.listImgName} 다운로드</span></a>
						</c:if>
						<label>이미지크기(711*415)</label>
					</span>
				</td>
			...
			<tr id="summaryKor">
				...
				<td>
					<textarea class="uiTextArea sizeFull" name="summaryKor" maxlength="200">${notice.summaryKor}</textarea>
			...
			<tr id="summaryEng">
				...
				<td>
					<textarea class="uiTextArea sizeFull" name="summaryEng" maxlength="200">${notice.summaryEng}</textarea>
					<label>최대 200자 까지 가능 합니다.</label>
				</td>
			</tr>
			<tr id="summaryChn">
				...
				<td>
					<textarea class="uiTextArea sizeFull" name="summaryChn" maxlength="200">${notice.summaryChn}</textarea>
					<label>최대 200자 까지 가능 합니다.</label>
				</td>
			</tr>
			<tr id="summaryJpn">
				...
				<td>
					<textarea class="uiTextArea sizeFull" name="summaryJpn" maxlength="200">${notice.summaryJpn}</textarea>
					<label>최대 200자 까지 가능 합니다.</label>
				</td>
			</tr>
			...
			<tr id="contentKor">
				...
				<td>
					<textarea class="uiTextArea sizeFull" id="contentKor_editor" rows="5" cols="100" style="width:100%; height:200px; display:none;">${notice.contentKor}</textarea>
				</td>
			</tr>
			<tr id="contentEng">
				<th>내용(영문)<span style="color:red;"> * </span></th>
				<td>
					<textarea class="uiTextArea sizeFull" id="contentEng_editor" rows="5" cols="100" style="width:100%; height:200px; display:none;">${notice.contentEng}</textarea>
				</td>
			</tr>
			<tr id="contentChn">
				<th>내용(중문)<span style="color:red;"> * </span></th>
				<td>
					<textarea class="uiTextArea sizeFull" id="contentChn_editor" rows="5" cols="100" style="width:100%; height:200px; display:none;">${notice.contentChn}</textarea>
				</td>
			</tr>
			<tr id="contentJpn">
				<th>내용(일문)<span style="color:red;"> * </span></th>
				<td>
					<textarea class="uiTextArea sizeFull" id="contentJpn_editor" rows="5" cols="100" style="width:100%; height:200px; display:none;">${notice.contentJpn}</textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<span class="uiInput text">
						<input type="text" name="releaseDt" class="datepicker_calendar" value="${notice.releaseDt}" readonly />
					</span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<span class="uiInput text">
						<fmt:formatDate value="${notice.createDt}" pattern="yyyy-MM-dd"/>
					</span>
				</td>
			</tr>
		</tbody>
...
<div id="single_btn">
	<table>
		...
		<tr>
			<td align="left">
				<a class="uiButton" href="${pageContext.request.contextPath}/admin/notice/list?page=${page}&list_exposure_yn=${list_exposure_yn}&top_exposure_yn=${top_exposure_yn}&keyfield=${keyfield}&keyword=${keyword}"><span>목록</span></a>
			</td>
			<td align="right">
...
<script>
	$(document).ready(function() {
		...
		init("${notice.topExposureYn}", "${notice.listExposureYn}");
	});
</script>