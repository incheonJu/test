						...
						<div class="inner">
							<div class="leftArea">
								...
								<div class="subNews">
									...
									<div class="btn">
										<a href="noticeGet/${top.seq}?page=${paging.currentPage}&keyfield=${keyfield}&keyword=${keyword}" class="btnMore">
				...
				<div class="contentWrap pt0">
					...
					<div class="pt100 relative">
						<div class="boardSearch">
							<form name="frmSearch" action="/kor/customer/noticeList" method="get">
									...
									<li>
										<div class="pressListCont">
											<div class="pressList_txt">
												<a href="noticeGet/${data.seq}?page=${paging.currentPage}&keyfield=${keyfield}&keyword=${keyword}">
										...
										<c:if test="${data.listImgPath != '' && data.listImgPath != null}">
											<div class="thumbnail">
												<a href="noticeGet/${data.seq}?page=${paging.currentPage}&keyfield=${keyfield}&keyword=${keyword}"><img src="/download${data.listImgPath}" width="245" height="143"></a>
											</div>
										</c:if>
									</li>
								</c:forEach>
					...
					<c:if test="${paging.totalRecordSize > 0}">
						...
						<c:import url="../../../common/user_paging.jsp">
							<c:param name="queryStr" value="/kor/customer/noticeList?keyfield=${keyfield}&keyword=${keyword}" />
						</c:import>
					</c:if>
					<!-- paging (e) -->
